					...
					<form class="form-horizontal" id="newest_services" action="<?php echo base_url('admin/settings/newestservices'); ?>"  method="POST" enctype="multipart/form-data" >
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="form-group">
									<label>Title</label>
									<input type="text" class="form-control" name="new_title_services" value="<?php echo settingValue('new_title_services'); ?>">
								</div>
								<div class="form-group">
									<label>Content</label>
									<input type="text" class="form-control" name="new_content_services" value="<?php echo settingValue('new_content_services'); ?>">
								</div>
								<div class="form-group">
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="form-group">
									<label>Title</label>
									<input type="text" class="form-control" name="rating_title_services" value="<?php echo settingValue('rating_title_services'); ?>">
								</div>
								<div class="form-group">
									<label>Content</label>
									<input type="text" class="form-control" name="rating_content_services" value="<?php echo settingValue('rating_content_services'); ?>">
								</div>
								<div class="form-group">
									<label class="form-head mb-0">Number of service<span>( Min 6 to Max 20 only )</span></label>
